videojs.registerPlugin('externalSrc', function(options) {
  ...
  var testGame = document.querySelector('meta[content="gamename=crucigramas-faciles"]')
  var testGameActive = (testGame && testGame.content === "gamename=crucigramas-faciles") ? true : false;
...
//	    var gameTarget = (window.document.getElementsByName('aarpAdUnit').length > 3 && window.document.getElementsByName('aarpAdUnit')[2].content == 'arcade') ? true : false;
    ...
    if(gameTarget && !gamesStageSiteEnabled){
    	  if(!!cookieValue && bcplaycapAdPlayed == 'true'|| v4app == null && gamesStageSiteEnabled2 == false && !testGameActive) {
